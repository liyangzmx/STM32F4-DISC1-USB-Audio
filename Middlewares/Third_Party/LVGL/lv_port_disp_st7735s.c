...
void lv_port_disp_init(void)
{
    ...
    /* Use a larger partial buffer to reduce fragmented text refresh artifacts
       while keeping the proven partial flush path. */
    static uint8_t disp_buf[LV_HOR_RES_MAX * (LV_VER_RES_MAX / 2) * 2];
